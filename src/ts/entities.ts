...
type RockSpriteSet = Record<RockSpriteColor, readonly string[]>;

const rockSpriteSources: RockSpriteSet = {
...
function pickWeightedSpriteColor() {
  const entries = Object.entries(rockSpriteConfig.weights) as Array<[RockSpriteColor, number]>;
...
function pickRandomSprite(color: RockSpriteColor) {
...
export function drawAsteroidSprite(
